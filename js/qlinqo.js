...
Qlinqo.Setup = function (playfieldLayer, foregroundLayer, backgroundLayer, debugLayer, statusLayer, gameOverLayer) {
	...
	Qlinqo.defaultFillColor = new Qlinqo.Util.ColorRGBA(28, 154, 183, 1);//(0,128,0,255);
	Qlinqo.defaultStrokeColor = new Qlinqo.Util.ColorRGBA(28, 154, 183, 1);//(0,102,34,255);
	...
	var pointValues = [10, 20, 30, 0, 30, 20, 10,];
